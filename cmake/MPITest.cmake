# MPI Testing Support for boost.ut
# Provides convenient functions for testing MPI applications
...
function(ut_add_mpi_test)
  ...
  set_tests_properties(${MPI_TEST_NAME} PROPERTIES
    ...
    PROCESSORS ${MPI_TEST_PROCESSES}  # CTest uses this for parallel test scheduling
  )
...
function(ut_add_mpi_executable)
  ...
  target_link_libraries(${MPI_EXE_NAME} PRIVATE 
    MPI::MPI_CXX
    Boost::ut
  )
